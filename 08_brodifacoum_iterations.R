...
Constants1 <- list(N=nrow(dat1),
                  sex=dat1$Sex,
                  WMU=wmua1, # random intercept
                  nWMUA=length(unique(dat1$WMUA)))
