...
for (i in 1:10) {
  ...
  pt_dredge <- dredge(m1g, subset=!(pctAG_15 && pctAG_4_5) &&
                                   !(pctAG_30 && pctAG_4_5) &&
                                   !(pctAG_60 && pctAG_4_5) &&
                                   !(pctAG_15 && pctAG_30) &&
                                   !(pctAG_15 && pctAG_60) &&
...
ag4_5 <- clmm(n.compounds.MO ~ km4_5 + (1|Region), data=pctAG1)
ag15 <- clmm(n.compounds.MO ~ km15 + (1|Region), data=pctAG1)
ag30 <- clmm(n.compounds.MO ~ km30 + (1|Region), data=pctAG1)
ag60 <- clmm(n.compounds.MO ~ km60 + (1|Region), data=pctAG1)
...
baa4_5 <- clmm(n.compounds.MO ~ km4_5 + (1|Region), data=baa1)
baa15 <- clmm(n.compounds.MO ~ km15 + (1|Region), data=baa1)
baa30 <- clmm(n.compounds.MO ~ km30 + (1|Region), data=baa1)
baa60 <- clmm(n.compounds.MO ~ km60 + (1|Region), data=baa1)
...
mix_45100 <- clmm(n.compounds.MO ~ b4_5km2_100m + (1|Region), data=intermix1)
mix_45250 <- clmm(n.compounds.MO ~ b4_5km2_250m + (1|Region), data=intermix1)
mix_45500 <- clmm(n.compounds.MO ~ b4_5km2_500m + (1|Region), data=intermix1)

mix_15100 <- clmm(n.compounds.MO ~ b15km2_100m + (1|Region), data=intermix1)
mix_15250 <- clmm(n.compounds.MO ~ b15km2_250m + (1|Region), data=intermix1)
mix_15500 <- clmm(n.compounds.MO ~ b15km2_500m + (1|Region), data=intermix1)

mix_30100 <- clmm(n.compounds.MO ~ b30km2_100m + (1|Region), data=intermix1)
mix_30250 <- clmm(n.compounds.MO ~ b30km2_250m + (1|Region), data=intermix1)
mix_30500 <- clmm(n.compounds.MO ~ b30km2_500m + (1|Region), data=intermix1)

mix_60100 <- clmm(n.compounds.MO ~ b60km2_100m + (1|Region), data=intermix1)
mix_60250 <- clmm(n.compounds.MO ~ b60km2_250m + (1|Region), data=intermix1)
mix_60500 <- clmm(n.compounds.MO ~ b60km2_500m + (1|Region), data=intermix1)
...
face_45100 <- clmm(n.compounds.MO ~ b4_5km2_100m + (1|Region), data=interface1)
face_45250 <- clmm(n.compounds.MO ~ b4_5km2_250m + (1|Region), data=interface1)
face_45500 <- clmm(n.compounds.MO ~ b4_5km2_500m + (1|Region), data=interface1)

face_15100 <- clmm(n.compounds.MO ~ b15km2_100m + (1|Region), data=interface1)
face_15250 <- clmm(n.compounds.MO ~ b15km2_250m + (1|Region), data=interface1)
face_15500 <- clmm(n.compounds.MO ~ b15km2_500m + (1|Region), data=interface1)

face_30100 <- clmm(n.compounds.MO ~ b30km2_100m + (1|Region), data=interface1)
face_30250 <- clmm(n.compounds.MO ~ b30km2_250m + (1|Region), data=interface1)
face_30500 <- clmm(n.compounds.MO ~ b30km2_500m + (1|Region), data=interface1)

face_60100 <- clmm(n.compounds.MO ~ b60km2_100m + (1|Region), data=interface1)
face_60250 <- clmm(n.compounds.MO ~ b60km2_250m + (1|Region), data=interface1)
face_60500 <- clmm(n.compounds.MO ~ b60km2_500m + (1|Region), data=interface1)
...
wui_45100 <- clmm(n.compounds.MO ~ b4_5km2_100m + (1|Region), data=wui1)
wui_45250 <- clmm(n.compounds.MO ~ b4_5km2_250m + (1|Region), data=wui1)
wui_45500 <- clmm(n.compounds.MO ~ b4_5km2_500m + (1|Region), data=wui1)

wui_15100 <- clmm(n.compounds.MO ~ b15km2_100m + (1|Region), data=wui1)
wui_15250 <- clmm(n.compounds.MO ~ b15km2_250m + (1|Region), data=wui1)
wui_15500 <- clmm(n.compounds.MO ~ b15km2_500m + (1|Region), data=wui1)

wui_30100 <- clmm(n.compounds.MO ~ b30km2_100m + (1|Region), data=wui1)
wui_30250 <- clmm(n.compounds.MO ~ b30km2_250m + (1|Region), data=wui1)
wui_30500 <- clmm(n.compounds.MO ~ b30km2_500m + (1|Region), data=wui1)

wui_60100 <- clmm(n.compounds.MO ~ b60km2_100m + (1|Region), data=wui1)
wui_60250 <- clmm(n.compounds.MO ~ b60km2_250m + (1|Region), data=wui1)
wui_60500 <- clmm(n.compounds.MO ~ b60km2_500m + (1|Region), data=wui1)
