...
# Run models
ag15 <- clmm(n.compounds.T ~ totalag_15 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
ag15sq <- clmm(n.compounds.T ~ totalag_15 + I(totalag_15^2) + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
ag30 <- clmm(n.compounds.T ~ totalag_30 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
ag30sq <- clmm(n.compounds.T ~ totalag_30 + I(totalag_30^2) +(1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
ag60 <- clmm(n.compounds.T ~ totalag_60 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
ag60sq <- clmm(n.compounds.T ~ totalag_60 + I(totalag_60^2) + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)

crop15 <- clmm(n.compounds.T ~ crops_15 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
crop15sq <- clmm(n.compounds.T ~ crops_15 + I(crops_15^2) + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
crop30 <- clmm(n.compounds.T ~ crops_30 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
crop30sq <- clmm(n.compounds.T ~ crops_30 + I(crops_30^2) +(1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
crop60 <- clmm(n.compounds.T ~ crops_60 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
crop60sq <- clmm(n.compounds.T ~ crops_60 + I(crops_60^2) + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)

past15 <- clmm(n.compounds.T ~ pasture_15 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
past15sq <- clmm(n.compounds.T ~ pasture_15 + I(pasture_15^2) + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
past30 <- clmm(n.compounds.T ~ pasture_30 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
past30sq <- clmm(n.compounds.T ~ pasture_30 + I(pasture_30^2) +(1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
past60 <- clmm(n.compounds.T ~ pasture_60 + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
past60sq <- clmm(n.compounds.T ~ pasture_60 + I(pasture_60^2) + (1|WMUA_code/WMU) + (1|WMU), data=pctAG1)
...
mix_15100 <- clmm(n.compounds.T ~ mix_15_100 + (1|WMUA_code/WMU), data=intermix1)
mix_15250 <- clmm(n.compounds.T ~ mix_15_250 + (1|WMUA_code/WMU), data=intermix1)
mix_15500 <- clmm(n.compounds.T ~ mix_15_500 + (1|WMUA_code/WMU), data=intermix1)
mix_15100sq <- clmm(n.compounds.T ~ mix_15_100 + I(mix_15_100^2) + (1|WMUA_code/WMU), data=intermix1)
mix_15250sq <- clmm(n.compounds.T ~ mix_15_250 + I(mix_15_250^2) + (1|WMUA_code/WMU), data=intermix1)
mix_15500sq <- clmm(n.compounds.T ~ mix_15_500 + I(mix_15_500^2) + (1|WMUA_code/WMU), data=intermix1)

mix_30100 <- clmm(n.compounds.T ~ mix_30_100 + (1|WMUA_code/WMU), data=intermix1)
mix_30250 <- clmm(n.compounds.T ~ mix_30_250 + (1|WMUA_code/WMU), data=intermix1)
mix_30500 <- clmm(n.compounds.T ~ mix_30_500 + (1|WMUA_code/WMU), data=intermix1)
mix_30100sq <- clmm(n.compounds.T ~ mix_30_100 + I(mix_30_100^2) + (1|WMUA_code/WMU), data=intermix1)
mix_30250sq <- clmm(n.compounds.T ~ mix_30_250 + I(mix_30_250^2) + (1|WMUA_code/WMU), data=intermix1)
mix_30500sq <- clmm(n.compounds.T ~ mix_30_500 + I(mix_30_500^2) + (1|WMUA_code/WMU), data=intermix1)

mix_60100 <- clmm(n.compounds.T ~ mix_60_100 + (1|WMUA_code/WMU), data=intermix1)
mix_60250 <- clmm(n.compounds.T ~ mix_60_250 + (1|WMUA_code/WMU), data=intermix1)
mix_60500 <- clmm(n.compounds.T ~ mix_60_500 + (1|WMUA_code/WMU), data=intermix1)
mix_60100sq <- clmm(n.compounds.T ~ mix_60_100 + I(mix_60_100^2) + (1|WMUA_code/WMU), data=intermix1)
mix_60250sq <- clmm(n.compounds.T ~ mix_60_250 + I(mix_60_250^2) + (1|WMUA_code/WMU), data=intermix1)
mix_60500sq <- clmm(n.compounds.T ~ mix_60_500 + I(mix_60_500^2) + (1|WMUA_code/WMU), data=intermix1)
...
face_15100 <- clmm(n.compounds.T ~ face_15_100 + (1|WMUA_code/WMU), data=interface1)
face_15250 <- clmm(n.compounds.T ~ face_15_250 + (1|WMUA_code/WMU), data=interface1)
face_15500 <- clmm(n.compounds.T ~ face_15_500 + (1|WMUA_code/WMU), data=interface1)
face_15100sq <- clmm(n.compounds.T ~ face_15_100 + I(face_15_100^2) + (1|WMUA_code/WMU), data=interface1)
face_15250sq <- clmm(n.compounds.T ~ face_15_250 + I(face_15_250^2) + (1|WMUA_code/WMU), data=interface1)
face_15500sq <- clmm(n.compounds.T ~ face_15_500 + I(face_15_500^2) + (1|WMUA_code/WMU), data=interface1)

face_30100 <- clmm(n.compounds.T ~ face_30_100 + (1|WMUA_code/WMU), data=interface1)
face_30250 <- clmm(n.compounds.T ~ face_30_250 + (1|WMUA_code/WMU), data=interface1)
face_30500 <- clmm(n.compounds.T ~ face_30_500 + (1|WMUA_code/WMU), data=interface1)
face_30100sq <- clmm(n.compounds.T ~ face_30_100 + I(face_30_100^2) + (1|WMUA_code/WMU), data=interface1)
face_30250sq <- clmm(n.compounds.T ~ face_30_250 + I(face_30_250^2) + (1|WMUA_code/WMU), data=interface1)
face_30500sq <- clmm(n.compounds.T ~ face_30_500 + I(face_30_500^2) + (1|WMUA_code/WMU), data=interface1)

face_60100 <- clmm(n.compounds.T ~ face_60_100 + (1|WMUA_code/WMU), data=interface1)
face_60250 <- clmm(n.compounds.T ~ face_60_250 + (1|WMUA_code/WMU), data=interface1)
face_60500 <- clmm(n.compounds.T ~ face_60_500 + (1|WMUA_code/WMU), data=interface1)
face_60100sq <- clmm(n.compounds.T ~ face_60_100 + I(face_60_100^2) + (1|WMUA_code/WMU), data=interface1)
face_60250sq <- clmm(n.compounds.T ~ face_60_250 + I(face_60_250^2) + (1|WMUA_code/WMU), data=interface1)
face_60500sq <- clmm(n.compounds.T ~ face_60_500 + I(face_60_500^2) + (1|WMUA_code/WMU), data=interface1)
