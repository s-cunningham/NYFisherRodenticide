...
dat2$coef <- c("Threshold0_1", "Threshold1_2", "Threshold2_3+", 
               "SexM", "Pasture (30km2)", "Intermix (100m, 30km2)", "Lagged BMI (30km2)")
...
dat3[2:6] <- sapply(dat3[2:6], as.numeric)

dat3$coef <- c("Threshold0_1", "Threshold1_2+", "SexM", "Pasture (30km2)", 
               "Intermix (100m, 30km2)", "Lagged BMI (30km2)")
...
dat4[2:6] <- sapply(dat4[2:6], as.numeric)
