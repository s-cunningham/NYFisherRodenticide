...
lsm_formulae <- list(n.compounds.T ~ ed_15 + (1|RegionalID),
                     ...
                     n.compounds.T ~ frac_15 + (1|RegionalID),
                     n.compounds.T ~ frac_30 + (1|RegionalID),
                     n.compounds.T ~ frac_60 + (1|RegionalID),
...
global_formulae <- list(n.compounds.T ~ Sex + Age + wui_60_100 + pasture_60 + BBA_60 * year + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + wui_60_100 + pasture_60 + BBA_60 * lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + build_cat_60*ai_60 + pasture_60 + BBA_60 * year + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + build_cat_60*mixed_30 + pasture_60 + BBA_60 * year + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + build_cat_60*ai_60 + pasture_60 + BBA_60 * year + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + build_cat_60*mixed_30 + pasture_60 + BBA_60 * year + (1|RegionalID),
