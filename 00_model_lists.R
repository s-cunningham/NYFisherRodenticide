...
beech_formulae <- list(n.compounds.T ~ Sex + Age + I(Age^2) + mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + lag_beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_15 + mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_30 + mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_60 + mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_15 * mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_30 * mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_60 * mast + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_15 * beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_30 * beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_60 * beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_15 * lag_beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_30 * lag_beechnuts + (1|RegionalID),
                       n.compounds.T ~ Sex + Age + I(Age^2) + BBA_60 * lag_beechnuts + (1|RegionalID)
                       )
...
global_formulae <- list(n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_15 * lag_beechnuts + (1|RegionalID),
                        ...
                        n.compounds.T ~ Sex + Age + I(Age^2) + build_cat_15 + totalforest_30 + crops_60 + BBA_30 * mast + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + build_cat_15 + totalforest_30 + crops_60 + BBA_30 * beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_15 + lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_30 + mast + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_30 + beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + totalag_15 + BBA_15 + lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + totalag_15 + BBA_30 + mast + (1|RegionalID),
