...
global_formulae <- list(n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_15 * lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_15 * mast + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + pasture_30 + BBA_15 * beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + totalag_15 + BBA_15 * lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + totalag_15 + BBA_15 * mast + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + wui_60_250 + totalag_15 + BBA_15 * beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + mix_30_250 + pasture_30 + BBA_15 * lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + mix_30_250 + pasture_30 + BBA_15 * mast + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + mix_30_250 + pasture_30 + BBA_15 * beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + mix_30_250 + totalag_15 + BBA_15 * lag_beechnuts + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + mix_30_250 + totalag_15 + BBA_15 * mast + (1|RegionalID),
                        n.compounds.T ~ Sex + Age + I(Age^2) + mix_30_250 + totalag_15 + BBA_15 * beechnuts + (1|RegionalID),
